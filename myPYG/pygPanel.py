...
# Fix for ibis DuckDB connection

con_ibis_duckdb = ibis.duckdb.connect("tmp.ibis.duckdb.db")
...
# Fix for ibis SQLite connection
con_ibis_sqlite = ibis.sqlite.connect("tmp.ibis.sqlite.db")
