...
import DAGEditorView from './cases/sample/DAGEditorView';
...
const examples = {
  ...
  'dag-editor': {
    name: 'DAG Editor (Save/Load)',
    component: <DAGEditorView />,
    code: ['DAGEditorView.js', 'DAGEditorUtils.js'],
    less: 'DAGEditorView.less',
    data: 'ReadOnlyViewData.js',
  }
};

function App() {
  const current = useHash() || 'dag-editor';
  const renderExample = () => {
